...
From _Table 4_, we notice that the coefficient for nonviol does not change a lot compared to the previous model, it only decrease 0.055. **p-value for nonviol(boostrap)... coefficient for viol.repress... p-value for viol.repress(bootstrap)...**
...
As we can see from _Table 5_, two different model produce almost the same probability based on two predictor.
=================
